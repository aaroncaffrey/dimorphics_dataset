...
//#endif
                ...
                var engine = init_r();
                {
                    ...
                    features.Add(new subsequence_classification_data.feature_info()
                    {
                        ...
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(aIndex)}",
                        member = $"{nameof(r_protr)}_{nameof(aIndex)}",
                        perspective = "default",
                    ...
                    autoCorrelation_result_list.ForEach(autoCorrelation_result => features.Add(new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(autoCorrelation)}",
                        member = $"{nameof(r_protr)}_{nameof(autoCorrelation)}_{autoCorrelation_result.prop}_lag{autoCorrelation_result.lag}",
                        perspective = "default",
                    ...
                    autoCovariance_result_list.ForEach(autoCovariance_result => features.Add(new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(autoCovariance)}",
                        member = $"{nameof(r_protr)}_{nameof(autoCovariance)}_{autoCovariance_result.prop}_lag{autoCovariance_result.lag}",
                        perspective = "default",
                    ...
                    features.AddRange(blosumIndices_result.Select(a => new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(blosumIndices)}",
                        member = $"{nameof(r_protr)}_{nameof(blosumIndices)}_{a.index}_{a.name}",
                        perspective = "default",
                    ...
                    features.Add(new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(boman)}",
                        member = $"{nameof(r_protr)}_{nameof(boman)}",
                        perspective = "default",
                    ...
                    charge_result_list.ForEach(charge_result => features.Add(new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(charge)}",
                        member = $"{nameof(r_protr)}_{nameof(charge)}_{charge_result.scale}_ph{charge_result.ph}",
                        perspective = "default",
                    ...
                    crossCovariance_result_list.ForEach(crossCovariance_result => features.Add(new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(crossCovariance)}",
                        member = $"{nameof(r_protr)}_{nameof(crossCovariance)}_{crossCovariance_result.prop1}_{crossCovariance_result.prop2}_lag{crossCovariance_result.lag}",
                        perspective = "default",
                    ...
                    features.AddRange(crucianiProperties_result.Select(a => new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(crucianiProperties)}",
                        member = $"{nameof(r_protr)}_{nameof(crucianiProperties)}_{a.index}_{a.name}",
                        perspective = "default",
                        feature_value = descriptive_stats.fix_double(a.value)
                    }).ToList());
                    ...
                    features.AddRange(fasgaiVectors_result.Select(a => new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(fasgaiVectors)}",
                        member = $"{nameof(r_protr)}_{nameof(fasgaiVectors)}_{a.index}_{a.name}",
                        perspective = "default",
                        feature_value = descriptive_stats.fix_double(a.value)
                    }).ToList());
                    ...
                    features.Add(new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(hmoment)}",
                        member = $"{nameof(r_protr)}_{nameof(hmoment)}",
                        perspective = "default",
                    ...
                    hydrophobicity_result_list.ForEach(hydrophobicity_result => features.Add(new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(hydrophobicity)}",
                        member = $"{nameof(r_protr)}_{nameof(hydrophobicity)}_{hydrophobicity_result.scale}",
                        perspective = "default",
                    ...
                    features.Add(new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(instaIndex)}",
                        member = $"{nameof(r_protr)}_{nameof(instaIndex)}",
                        perspective = "default",
                    ...
                    features.AddRange(kideraFactors_result.Select(a => new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(kideraFactors)}",
                        member = $"{nameof(r_protr)}_{nameof(kideraFactors)}_{a.index}_{a.name}",
                        perspective = "default",
                        feature_value = descriptive_stats.fix_double(a.value)
                    }).ToList());
                    ...
                    features.AddRange(mswhimScores_result.Select(a => new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(mswhimScores)}",
                        member = $"{nameof(r_protr)}_{nameof(mswhimScores)}_{a.index}_{a.name}",
                        perspective = "default",
                        feature_value = descriptive_stats.fix_double(a.value)
                    }).ToList());
                    ...
                    features.Add(new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(mw)}",
                        member = $"{nameof(r_protr)}_{nameof(mw)}",
                        perspective = "default",
                    ...
                    features.Add(new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(pI)}",
                        member = $"{nameof(r_protr)}_{nameof(pI)}",
                        perspective = "default",
                    ...
                    features.AddRange(protFP_result.Select(a => new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(protFP)}",
                        member = $"{nameof(r_protr)}_{nameof(protFP)}_{a.index}_{a.name}",
                        perspective = "default",
                        feature_value = descriptive_stats.fix_double(a.value)
                    }).ToList());
                    ...
                    features.AddRange(stScales_result.Select(a => new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(stScales)}",
                        member = $"{nameof(r_protr)}_{nameof(stScales)}_{a.index}_{a.name}",
                        perspective = "default",
                        feature_value = descriptive_stats.fix_double(a.value)
                    }).ToList());
                    ...
                    features.AddRange(tScales_result.Select(a => new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(tScales)}",
                        member = $"{nameof(r_protr)}_{nameof(tScales)}_{a.index}_{a.name}",
                        perspective = "default",
                        feature_value = descriptive_stats.fix_double(a.value)
                    }).ToList());
                    ...
                    features.AddRange(vhseScales_result.Select(a => new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(vhseScales)}",
                        member = $"{nameof(r_protr)}_{nameof(vhseScales)}_{a.index}_{a.name}",
                        perspective = "default",
                        feature_value = descriptive_stats.fix_double(a.value)
                    }).ToList());
                    ...
                    features.AddRange(zScales_result.Select(a => new subsequence_classification_data.feature_info()
                    {
                        ...
                        category = $"{nameof(r_protr)}",
                        source = source,
                        @group = $"{nameof(r_protr)}_{nameof(zScales)}",
                        member = $"{nameof(r_protr)}_{nameof(zScales)}_{a.index}_{a.name}",
                        perspective = "default",
                        feature_value = descriptive_stats.fix_double(a.value)
                    }).ToList());
