...
namespace dimorphics_dataset
{
    internal static class subsequence_classification_data_templates
    {
        ...
        internal static List<feature_info> _calculate_sable_classification_data_template = null;
        ...
        internal static List<feature_info> _calculate_aa_index_classification_data_template = null;
        internal static List<feature_info> _calculate_dna_binding_prediction_data_template = null;
        internal static List<feature_info> _calculate_intrinsically_unordered_data_template = null;
        internal static List<feature_info> _calculate_blast_pssm_classification_data_template = null;
        internal static List<feature_info> _calculate_sasa_classification_data_template = null;
        internal static List<feature_info> _calculate_tortuosity_classification_data_template = null;
        internal static List<feature_info> _calculate_atom_distances_data_template;
        internal static List<feature_info> _calculate_aa_or_ss_sequence_classification_data_aa_template = null;
        internal static List<feature_info> _calculate_aa_or_ss_sequence_classification_data_ss_template = null;
        internal static List<feature_info> _peptides_data_template = null;
        internal static List<feature_info> _protr_data_template = null;
    }
}
